...
namespace Thawed.UnitTests.Auto
{
    public class ArithmeticTest : AbstractDecodeTest
    {
        ...
        public void CheckAdcV10(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
        ...
        public void CheckAddV10(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
        ...
        public void CheckCmpV10(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
        ...
        public void CheckDecV4(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
        ...
        public void CheckDivV2(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
        ...
        public void CheckIdivV2(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
        ...
        public void CheckImulV4(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
        ...
        public void CheckIncV4(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
        ...
        public void CheckMulV2(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
        ...
        public void CheckNegV2(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
        ...
        public void CheckSbbV10(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
        ...
        public void CheckSubV10(string bin, string op, string arg)
            => AssertDecode(bin, op, arg);
        #endregion
    }
}
